    ...
    <section className="bg-slate-50 py-24 dark:bg-slate-900" ref={containerRef}>
      <div className="container">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          <span className="mb-4 inline-block rounded-full bg-gradient-to-r from-cyan-500/10 to-blue-500/10 px-3 py-1 text-sm font-medium text-cyan-600 dark:text-cyan-400">
            Our Approach
          </span>
